...
export default class ElevenLabsPlugin extends TTSPlugin<ElevenLabsPluginOptions> {
    ...
    describe(): PluginDescription {
        return {
            id: "elevenlabs",
            name: "Texto a voz de ElevenLabs",
            options: [
                {
                    id: "apiKey",
                    defaultValue: null,
                    ...
                    renderProps: (value, options, context) => ({
                        type: "password",
                        label: context.intl.formatMessage({ defaultMessage: "Tu clave API de ElevenLabs" }),
                        placeholder: context.intl.formatMessage({ defaultMessage: "Pega tu clave API aquí" }),
                        description: <>
                            <p>
                                <FormattedMessage
                                    defaultMessage="Dale a ChatGPT una voz humana realista conectando tu cuenta de ElevenLabs (Vista previa de las voces disponibles a continuación). <a>Haga clic aquí para registrarse.</a>"
                                    values={{
                                        a: (chunks: any) => <a href="https://beta.elevenlabs.io" target="_blank" rel="noreferrer">{chunks}</a>
                                    }} />
                            </p>
                            <p>
                                <FormattedMessage defaultMessage="Puede encontrar su clave API haciendo clic en su avatar o iniciales en la parte superior derecha del sitio web de ElevenLabs y luego haciendo clic en el perfil. Su clave API se almacena solo en este dispositivo y nunca se transmite a nadie excepto a ElevenLabs." />
                            </p>
                        </>,
                    ...
                    renderProps: (value, options, context) => {
                        return {
                            ...
                            options: [
                                ...
                                {
                                    label: context.intl.formatMessage({ defaultMessage: "ID de voz personalizado" }),
                                    value: 'custom',
                                }
                            ],
                        };
