            ...
            options: [
                {
                    ...
                    renderProps: (value, options) => ({
                        label: `Incluye un máximo de ${value} tokens`,
                        type: "slider",
                        min: 1024,
                        max: maxTokensByModel[options.getOption('parameters', 'model')] || 32768,
                        step: 1024,
                    }),
                ...
                // },
                {
                    ...
                    scope: "chat",
                    renderProps: {
                        label: "Intenta incluir siempre el mensaje del sistema",
                        type: "checkbox",
                    },
                },
                {
                    ...
                    scope: "chat",
                    renderProps: {
                        label: "Intenta incluir siempre tu primer mensaje",
                        type: "checkbox",
                    },
                },
            ],
